...
import { MonthlyData, CreatePropertyInput } from '@northstar/shared-types'
    ...
    return (
      <div>
        <Header
          title="Add Property"
          actions={
            <button onClick={() => navigate('/properties')} className="text-sm text-gray-500 hover:text-gray-700">
              ← Back
            </button>
          }
        />
        <PageContainer className="max-w-2xl">
          <PropertyForm onSubmit={handleCreateProperty} onCancel={() => navigate('/properties')} />
        </PageContainer>
      </div>
    )
  }
